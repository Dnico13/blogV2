        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                <div class="p-4 rounded-4 mt-5 border d-flex align-items-center justify-content-between flex-wrap gap-3" 
                    ...
                    <a href="https://www.developpeurweb83.fr" target="_blank" class="btn btn-outline-light btn-sm rounded-pill px-3">
                        Voir mon Portfolio <i class="fas fa-external-link-alt ms-1" style="font-size: 0.8rem;"></i>
                    </a>
                </div>
